    ...
    >
      <div className="max-w-4xl mx-auto text-center space-y-4 px-4">
        ...
        <AnimatedText keyProp={`footer-title-${language}`}>
          © {new Date().getFullYear()} Alejandro Villagrán - {language === 'es' ? 'Desarrollador Fullstack' : 'Fullstack Developer'}
          </AnimatedText>
        </p>
        ...
        <div className="flex justify-center gap-6 mt-4">
          ...
          <a
            ...
            aria-label={language === 'es' ? 'Perfil de LinkedIn de Alejandro Villagrán' : "Alejandro Villagrán's LinkedIn Profile"}
            className={`${linkHoverColor} transition`}
          >
            <Linkedin className="w-6 h-6" />
          </a>
          <a
            href="mailto:alejandro18maestro@gmail.com"
            aria-label={language === 'es' ? 'Enviar correo electrónico a Alejandro Villagrán' : "Send email to Alejandro Villagrán"}
            className={`${linkHoverColor} transition`}
          >
