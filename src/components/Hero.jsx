...
import ImagenPerfil from "../assets/AlePerfil.jpeg"; // Asegúrate que esta ruta sea correcta
...
function Hero({ isDarkMode, language }) {
  ...
  const cvFileName = language === 'es' ? 'CV_Ale_villagran.pdf' : 'CV_Ale_villagran.pdf';
      ...
      <div
            ...
            >
              <p className="text-sm font-medium leading-snug">
                {language === 'es'
                  ? '¡Hola! Soy Alejandro, desarrollador full-stack creativo y técnico. Conoce más sobre mi.'
                  : 'Hi! I’m Alejandro, a creative and technical full-stack developer. Learn more about me.'}
              </p>
              <div
          ...
          <a
            href="https://www.linkedin.com/in/alejandro-villagran/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label={language === 'es' ? 'Perfil de LinkedIn de Alejandro Villagrán, disponible para trabajar' : ' Alejandro Villagrán LinkedIn profile, available for work'}
 ...
 // Color en hover: cyan claro (oscuro), sky blue (claro)
        ...
        <motion.div variants={itemVariants}>
          ...
          >
            {language === 'es'
              ? 'Desarrollador Full-Stack | Creativo | Apasionado por la tecnología'
        ...
        >
          ...
          <a
            href="mailto:alejandro18maestro@gmail.com?subject=Contacto%20desde%20Portfolio&body=Hola%Alejandro,"
