...
const content = {
  es: {
    ...
    nameValue: 'Alejandro Javier Villagrán Poblete',
    locationLabel: 'Ubicación',
    locationValue: 'Temuco, Chile',
    emailLabel: 'Email',
    emailValue: 'alejandro18maestro@gmail.com',
    emailHref: 'mailto:Alejandro18maestro@gmail.com',
    linkedinLabel: 'LinkedIn',
    linkedinValueText: 'alejandro-villagran',
    linkedinHref: 'https://www.linkedin.com/in/alejandro-villagran/',
    githubLabel: 'GitHub',
    githubValueText: 'alejandromvp',
    githubHref: 'https://github.com/alejandromvp',
  },
  en: {
